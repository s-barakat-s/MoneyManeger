...
String _description(ActivityAction? action) {
  return switch (action) {
    ...
    ActivityAction.assetCreated => 'Created a company asset',
    ActivityAction.assetUpdated => 'Updated a company asset',
    ActivityAction.assetArchived => 'Archived a company asset',
